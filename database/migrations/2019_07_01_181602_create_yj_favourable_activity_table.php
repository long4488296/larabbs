...
class CreateYjFavourableActivityTable extends Migration {
	...
	public function up()
	{
		Schema::create('yj_favourable_activity', function(Blueprint $table)
		{
	...
	{
		Schema::drop('yj_favourable_activity');
	}
